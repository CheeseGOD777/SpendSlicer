...
from aws_cost_ultra.web.middleware import CECallCounter, get_current_counter
...
def test_middleware_writes_headers():
    ...
    from aws_cost_ultra.web.middleware import CECountingMiddleware, get_current_counter
