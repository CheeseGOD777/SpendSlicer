...
log = logging.getLogger("spendslicer.cost_store")
...
class DailyServiceMatrix:
    ...
    def to_grouped_cost_list(self, provenance: Any) -> list:
        ...
        from spendslicer.aws.cost_explorer import GroupedCost  # local to dodge any cycle
...
class CostStore:
    ...
    def attribute_resources_via_describe(
        ...
        """
        from spendslicer.resources.runner import enumerate_all
