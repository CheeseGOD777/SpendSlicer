...
Only kicks in when SPENDSLICER_ENABLE_PREWARM is truthy (handled by web/app.py).
...
from spendslicer.web.deps import get_cost_source, get_session, period_to_window

log = logging.getLogger("spendslicer.prewarm")
