...
from spendslicer.core.service_groups import merge_ec2_service_groups, service_rows_from_groups
...
_FANOUT_POOL = ThreadPoolExecutor(max_workers=8, thread_name_prefix="spendslicer-fanout")
