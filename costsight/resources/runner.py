...
from costsight.aws.session import accessible_regions
from costsight.core.filters import CostFilterSpec, pre_credit_gross
...
def _service_region_totals(
    ...
    """
    from costsight.core.filters import build_ce_filter
    ...
    while True:
        ...
        try:
            from costsight.web.middleware import get_current_counter
