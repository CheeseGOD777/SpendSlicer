...
Only kicks in when COSTSIGHT_ENABLE_PREWARM is truthy (handled by web/app.py).
...
from costsight.web.deps import get_cost_source, get_session, period_to_window

log = logging.getLogger("costsight.prewarm")
